/*
  ...
  - Added the required column `black_rank` to the `games` table without a default value. This is not possible if the table is not empty.
  - Added the required column `white_rank` to the `games` table without a default value. This is not possible if the table is not empty.
