...
INSERT INTO "new_games" ("black_id", "black_rank", "black_time", "created_at", "date", "end_time", "id", "kif", "location", "moves", "start_time", "time_limit", "title", "tournament", "updated_at", "white_id", "white_rank", "white_time") SELECT "black_id", "black_rank", "black_time", "created_at", "date", "end_time", "id", "kif", "location", "moves", "start_time", "time_limit", "title", "tournament", "updated_at", "white_id", "white_rank", "white_time" FROM "games";
DROP TABLE "games";
